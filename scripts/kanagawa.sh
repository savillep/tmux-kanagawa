...
main() {
  ...
  *)
  ...
  if $show_powerline; then
    ...
    tmux set-window-option -g window-status-current-format "#[fg=${white},bg=${dark_gray}]${left_sep}#[fg=${white},bg=${dark_purple}] #I #W${current_flags} #[fg=${dark_purple},bg=${gray}]${left_sep}"
  else
